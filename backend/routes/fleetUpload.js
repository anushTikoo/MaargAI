...
import { insertTruckRecord } from '../utils/truckPersistence.js';
import { mapExcelSheetsToTruckFields } from '../utils/geminiTruckMapper.js';
...
// POST /api/fleet/excel-to-json
router.post('/excel-to-json', async (request, response) => {
    try {
        ...
        const mappedRows = await mapExcelSheetsToTruckFields(nonEmptySheets);
